    ...
    if call.data.startswith("vid:"):
        ...
        def download_task():
            ...
            try:
                ...
                ydl_opts = {
                    'format': 'bestaudio[ext=m4a]/bestaudio/best' if type_dl == 'a' else 'bestvideo[ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]/best',
                    ...
                    'socket_timeout': 30,
                    'retries': 10,
                    'merge_output_format': 'mp4' if type_dl == 'v' else None,
                    'postprocessors': [{'key': 'FFmpegExtractAudio', 'preferredcodec': 'mp3', 'preferredquality': '192'}] if type_dl == 'a' else [],
                }
